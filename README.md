...
[OpenBlouco](https://open.bloucos.art/) - códigos para botar seu Blouco na rua


![Imagem representativa dos Elementos (Ambientes) e Divindades (Funções) do Blouco](https://open.bloucos.art/pt_BR/latest/_images/chave.png)
...
As *labels* marcadas com símbolos de elementos e planetas da astrologia clssica estão relacionadas respectivamente aos Ambientes e Funções do Blouco, como documentados no momento aqui neste repositório e publicado em [open.bloucos.art](https://open.bloucos.art) através do ReadTheDocs.
