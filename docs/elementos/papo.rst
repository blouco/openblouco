...
.. image:: /images/elementos/papo/papo_freenode.png
   :align: center
   :width: 600px
...
Vamos utilizar o Freenode, por conta de sua praticidade e gratuidade mas
...
humanos e máquinas.
    ...
    Freenode, conhecida anteriormente como Open Projects Network, é uma rede de
    IRC muito popular entre usuários de software livre e programadores. É a
    rede oficial de vários projetos open source importantes, como o Slackware,
    Ubuntu, Gentoo GNU/Linux, e outros. A rede alega sustentar mais de 23.500
    conexões simultâneas em momentos de pico.

    Usuários da rede são encorajados a contribuir com o Peer-Directed Projects
    Center. Os fundos doados são usados para continuar as melhorias na rede,
    assim como possibilitar que o PDPC apóie vários projetos de apoio social
    para as comunidades de software livre.


O Freenode hospeda uma versão do KiwiIRC e torna muito fácil embutir um chat dentro da -- é o que estamos fazendo com as páginas da :ref:`Rua`! Ele pode ser acessado de forma independente por aqui:
...
.. image:: /images/elementos/papo/papo.png
   :align: center
   :width: 600px
...
.. image:: /images/elementos/papo/papo_dm.png
   :align: center
   :width: 600px
...
.. image:: /images/elementos/papo/papo_op.png
   :align: center
   :width: 600px
