...
O endereço `hash.bloucos.art <https://hash.bloucos.art>`_ está sendo mantido com a última versão em desenvolvimento. Você pode criar um Estandarte a partir de qualquer palavra, frase, *hash MD5*, ou outro conteúdo.
...
.. image:: images/hashfolia_web.png
   :width: 70%
   :align: center
